...
def Compare_results_diff_files():
    ...
    file_path1 = os.path.abspath("./Segments/Passengership/12_segment_0240.wav")
    file_path2 = os.path.abspath("./Segments/Tug/020446_segment_1088.wav")
    ...
    # Affichage des dimensions des caractéristiques fusionnées 
...
if __name__ == "__main__":
    ...
    if compare:
       ...
       # file_path = os.path.abspath("./Segments/Cargo/99_segment_3060.wav")
        ...
        # file_path = os.path.abspath("./Segments/RESSACH/5084.220822235505.flac")
        # file_path = os.path.abspath("./Segments/Tanker/99_segment_3060.wav")
